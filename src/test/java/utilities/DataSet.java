...
public class DataSet {
    ...
    public static Object[][] invalidLoginData () {
        return new Object[][]{
                ...
                {"foysal@292", "12345678", "non_field_errors: Account with this email/username does not exists", "", ""},
    ...
    public static Object[][] validPasswordResetData () {
        return new Object[][]{
                {"foysal.easytrax@gmail.com", "Instructions for resetting your password has been sent to your email. " +
